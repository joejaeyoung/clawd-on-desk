...
(function initSettingsI18n(root) {
  const STRINGS = {
    ...
    zh: {
      ...
      sidebarPermissionPolicy: "权限策略",
      permissionPolicyTitle: "权限策略",
      permissionPolicySubtitle: "按工具类型决定是否自动允许、以气泡询问或自动拒绝 Agent 的权限请求。",
      permissionPolicyGlobalSection: "全局策略",
      permissionPolicyDirSection: "目录规则",
      permissionPolicyDirDesc: "适用于工作目录在该路径下的请求。最长匹配路径优先；设为「继承」的类型回退到全局策略。",
      permissionPolicyAddRule: "+ 添加规则",
      permissionPolicyRemoveRule: "删除",
      permissionPolicyKindRead: "读取",
      permissionPolicyKindEdit: "编辑 / 写入",
      permissionPolicyKindExec: "Shell / 执行",
      permissionPolicyKindNetwork: "网络",
      permissionPolicyKindOther: "其他工具",
      permissionPolicyActionAllow: "自动允许",
      permissionPolicyActionBubble: "气泡询问",
      permissionPolicyActionDeny: "自动拒绝",
      permissionPolicyActionInherit: "继承",
    },
    "zh-TW": {
      settingsTitle: "設定",
      ...
      sidebarPermissionPolicy: "權限策略",
      permissionPolicyTitle: "權限策略",
      permissionPolicySubtitle: "依工具類型決定是否自動允許、以氣泡詢問或自動拒絕 Agent 的權限請求。",
      permissionPolicyGlobalSection: "全域策略",
      permissionPolicyDirSection: "目錄規則",
      permissionPolicyDirDesc: "適用於工作目錄在該路徑下的請求。最長符合路徑優先；設為「繼承」的類型回退至全域策略。",
      permissionPolicyAddRule: "+ 新增規則",
      permissionPolicyRemoveRule: "刪除",
      permissionPolicyKindRead: "讀取",
      permissionPolicyKindEdit: "編輯 / 寫入",
      permissionPolicyKindExec: "Shell / 執行",
      permissionPolicyKindNetwork: "網路",
      permissionPolicyKindOther: "其他工具",
      permissionPolicyActionAllow: "自動允許",
      permissionPolicyActionBubble: "氣泡詢問",
      permissionPolicyActionDeny: "自動拒絕",
      permissionPolicyActionInherit: "繼承",
    },
    ko: {
      settingsTitle: "설정",
    ...
    ja: {
      ...
      sidebarPermissionPolicy: "権限ポリシー",
      permissionPolicyTitle: "権限ポリシー",
      permissionPolicySubtitle: "ツール種別ごとにエージェントの権限リクエストを自動許可・バブル表示・自動拒否のいずれかに設定します。",
      permissionPolicyGlobalSection: "グローバルポリシー",
      permissionPolicyDirSection: "ディレクトリルール",
      permissionPolicyDirDesc: "作業ディレクトリが該当パス配下のリクエストに適用されます。最も長いパスが優先され、「継承」はグローバルポリシーにフォールバックします。",
      permissionPolicyAddRule: "+ ルールを追加",
      permissionPolicyRemoveRule: "削除",
      permissionPolicyKindRead: "読み取り",
      permissionPolicyKindEdit: "編集 / 書き込み",
      permissionPolicyKindExec: "シェル / 実行",
      permissionPolicyKindNetwork: "ネットワーク",
      permissionPolicyKindOther: "その他のツール",
      permissionPolicyActionAllow: "自動許可",
      permissionPolicyActionBubble: "バブル表示",
      permissionPolicyActionDeny: "自動拒否",
      permissionPolicyActionInherit: "継承",
    },
  };
