...
const SIDEBAR_TABS = [
  ...
  { id: "permission-policy", labelKey: "sidebarPermissionPolicy", available: true },
...
if (globalThis.ClawdSettingsTabPermissionPolicy) globalThis.ClawdSettingsTabPermissionPolicy.init(core);
